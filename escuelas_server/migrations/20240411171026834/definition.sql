...
CREATE TABLE "calificaciones" (
    ...
    "asignaturaId" integer NOT NULL,
    "idInstanciaDeEvaluacion" integer,
...
--
-- Class ComentarioHiloDeNotificaciones as table comentarios_hilo_de_notificaciones
--
...
--
-- Class ContactoDeEmergencia as table contactos_de_emergencia
--
...
--
-- Class EmailEnviado as table emails_enviados
--
...
--
-- Class HiloDeNotificaciones as table hilos_de_notificaciones
--
...
--
-- Class Notificacion as table notificaciones
--
...
--
-- Class PlantillaComunicacion as table plantillas_comunicacion
--
...
--
-- Class RelacionComentarioHiloDeNotificacionesUsuario as table r_comentario_hilo_de_notificacion_usuario
--
...
--
-- Class RelacionHiloDeNotificacionesUsuario as table r_hilo_de_notificaciones_usuario
--
...
--
-- Class SolicitudEnvioNotificacion as table solicitudes_envio_notificacion
--
...
CREATE TABLE "usuarios" (
    ...
    "fechaEliminacion" timestamp without time zone,
    "privileges" text,
    "necesitaCambiarPassword" boolean NOT NULL
);
...
--
-- Class VersionDb as table version_db
--
...
--
-- Foreign relations for "comentarios_hilo_de_notificaciones" table
--
...
--
-- Foreign relations for "emails_enviados" table
--
...
--
-- Foreign relations for "hilos_de_notificaciones" table
--
...
--
-- Foreign relations for "notificaciones" table
--
...
--
-- Foreign relations for "r_asignatura_curso" table
--
...
--
-- Foreign relations for "r_comentario_hilo_de_notificacion_usuario" table
--
...
--
-- Foreign relations for "r_hilo_de_notificaciones_usuario" table
--
...
--
-- Foreign relations for "solicitudes_calificaciones_mensuales" table
--
...
--
-- Foreign relations for "solicitudes_envio_notificacion" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('escuelas', '20240411171026834', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240411171026834', "timestamp" = now();
