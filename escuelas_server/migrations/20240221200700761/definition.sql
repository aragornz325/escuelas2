...
-- Indexes
CREATE UNIQUE INDEX "r_usuario_asignatura_index_idx" ON "r_asignaturas_usuarios" USING btree ("asignaturaId");
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('escuelas', '20240221200700761', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240221200700761', "timestamp" = now();
