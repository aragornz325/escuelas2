...
CREATE TABLE "usuarios_pendientes" (
    ...
    "urlFotoDePerfil" text NOT NULL,
    "dni" text,
    "idrRolSolicitado" integer NOT NULL,
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('escuelas', '20240118161739350', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240118161739350', "timestamp" = now();
