...
import 'package:escuelas_flutter/features/dashboard/inasistencias/widgets/boton_finalizar_inasistencias.dart';
import 'package:escuelas_flutter/features/dashboard/inasistencias/widgets/item_curso.dart';
          ...
          child: ElementoLista.inasistencia(
            fotoPerfil: SizedBox(
              ...
              child: ClipRRect(
                ...
                child: Image.network(
                  estudiante?.usuario?.urlFotoDePerfil ?? '',
                  fit: BoxFit.cover,
                  errorBuilder: (
                    context,
                    error,
