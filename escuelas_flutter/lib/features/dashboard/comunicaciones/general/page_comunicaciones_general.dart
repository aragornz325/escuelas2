...
/// {@template PaginaComunicacionesGeneral}
// TODO(ANYONE): Add docu
/// {@endtemplate}
@RoutePage()
class PaginaComunicacionesGeneral extends StatelessWidget {
  /// {@macro PaginaComunicacionesGeneral}
  const PaginaComunicacionesGeneral({super.key});
