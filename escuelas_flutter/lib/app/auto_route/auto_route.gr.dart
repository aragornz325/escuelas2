...
import 'package:escuelas_client/escuelas_client.dart' as _i39;
...
import 'package:escuelas_flutter/features/dashboard/perfil_usuario/pagina_perfil_usuario_pendiente.dart'
    as _i29;
import 'package:escuelas_flutter/features/dashboard/supervision/pagina_supervision.dart'
    as _i32;
import 'package:escuelas_flutter/features/dashboard/supervision/supervision_asignatura/pagina_supervision_asignatura.dart'
    as _i33;
import 'package:escuelas_flutter/features/dashboard/supervision/supervision_comisiones/pagina_supervision_comisiones.dart'
    as _i34;
import 'package:escuelas_flutter/features/dashboard/supervision/supervision_envio_calificaciones/pagina_supervision_envio_calificaciones.dart'
    as _i35;
...
abstract class $AppRouter extends _i37.RootStackRouter {
  ...
  final Map<String, _i37.PageFactory> pagesMap = {
    ...
    RutaSupervision.name: (routeData) {
      return _i37.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i32.PaginaSupervision(),
      );
    },
    RutaSupervisionAsignatura.name: (routeData) {
      final pathParams = routeData.inheritedPathParams;
      final args = routeData.argsAs<RutaSupervisionAsignaturaArgs>(
          orElse: () => RutaSupervisionAsignaturaArgs(
                idAsignatura: pathParams.getInt('idAsignatura'),
                idComision: pathParams.getInt('idComision'),
                fecha: pathParams.getString('fecha'),
              ));
      return _i37.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i33.PaginaSupervisionAsignatura(
          idAsignatura: args.idAsignatura,
          idComision: args.idComision,
          fecha: args.fecha,
          key: args.key,
    ...
    RutaSupervisionComisiones.name: (routeData) {
      return _i37.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i34.PaginaSupervisionComisiones(),
      );
    },
    RutaSupervisionEnvioCalificaciones.name: (routeData) {
      ...
      return _i37.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i35.PaginaSupervisionEnvioCalificaciones(
          idComision: args.idComision,
          fecha: args.fecha,
          key: args.key,
        ),
    ...
    RutaUsuariosPendientes.name: (routeData) {
      return _i37.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i36.PaginaUsuariosPendientes(),
      );
    },
  };
}
...
class RutaAdministrarPlantillas extends _i37.PageRouteInfo<void> {
  const RutaAdministrarPlantillas({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaCalificacionesAnuales
    extends _i37.PageRouteInfo<RutaCalificacionesAnualesArgs> {
  ...
  static const _i37.PageInfo<RutaCalificacionesAnualesArgs> page =
      _i37.PageInfo<RutaCalificacionesAnualesArgs>(name);
}
...
class RutaCalificacionesMensuales extends _i37.PageRouteInfo<void> {
  const RutaCalificacionesMensuales({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaCargaDeCalificaciones
    extends _i37.PageRouteInfo<RutaCargaDeCalificacionesArgs> {
  ...
  static const _i37.PageInfo<RutaCargaDeCalificacionesArgs> page =
      _i37.PageInfo<RutaCargaDeCalificacionesArgs>(name);
}
...
class RutaComisiones extends _i37.PageRouteInfo<void> {
  const RutaComisiones({List<_i37.PageRouteInfo>? children})
      : super(
          RutaComisiones.name,
          initialChildren: children,
        );
...
class RutaComunicaciones extends _i37.PageRouteInfo<void> {
  const RutaComunicaciones({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaComunicacionesCursos extends _i37.PageRouteInfo<void> {
  const RutaComunicacionesCursos({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaComunicacionesGeneral extends _i37.PageRouteInfo<void> {
  const RutaComunicacionesGeneral({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaComunicacionesListaCursos extends _i37.PageRouteInfo<void> {
  const RutaComunicacionesListaCursos({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaComunicacionesPendientes extends _i37.PageRouteInfo<void> {
  const RutaComunicacionesPendientes({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaComunidadAcademica extends _i37.PageRouteInfo<void> {
  const RutaComunidadAcademica({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaDashboard extends _i37.PageRouteInfo<RutaDashboardArgs> {
  RutaDashboard({
    required _i39.Usuario usuario,
    required _i40.UserInfo userInfo,
    _i38.Key? key,
    List<_i37.PageRouteInfo>? children,
  }) : super(
          RutaDashboard.name,
  ...
  static const _i37.PageInfo<RutaDashboardArgs> page =
      _i37.PageInfo<RutaDashboardArgs>(name);
}
...
class RutaDashboardArgs {
  ...
  final _i39.Usuario usuario;

  final _i40.UserInfo userInfo;
...
class RutaEditarPerfil extends _i37.PageRouteInfo<RutaEditarPerfilArgs> {
  RutaEditarPerfil({
  ...
  static const _i37.PageInfo<RutaEditarPerfilArgs> page =
      _i37.PageInfo<RutaEditarPerfilArgs>(name);
}
...
/// generated route for
/// [_i14.PaginaEspera]
class RutaEspera extends _i37.PageRouteInfo<void> {
  const RutaEspera({List<_i37.PageRouteInfo>? children})
      : super(
          RutaEspera.name,
          initialChildren: children,
        );
...
class RutaFormulario extends _i37.PageRouteInfo<void> {
  const RutaFormulario({List<_i37.PageRouteInfo>? children})
      : super(
          RutaFormulario.name,
          initialChildren: children,
        );
...
class RutaGestionDeComision
    extends _i37.PageRouteInfo<RutaGestionDeComisionArgs> {
  ...
  static const _i37.PageInfo<RutaGestionDeComisionArgs> page =
      _i37.PageInfo<RutaGestionDeComisionArgs>(name);
}
...
class RutaInasistencia extends _i37.PageRouteInfo<void> {
  const RutaInasistencia({List<_i37.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i18.PaginaInicio]
class RutaInicio extends _i37.PageRouteInfo<void> {
  const RutaInicio({List<_i37.PageRouteInfo>? children})
      : super(
          RutaInicio.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i19.PaginaKyc]
class RutaKyc extends _i37.PageRouteInfo<void> {
  const RutaKyc({List<_i37.PageRouteInfo>? children})
      : super(
          RutaKyc.name,
          initialChildren: children,
        );
...
class RutaListaCursos extends _i37.PageRouteInfo<void> {
  const RutaListaCursos({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaListaDeComisiones extends _i37.PageRouteInfo<void> {
  const RutaListaDeComisiones({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaListadoComunidad
    extends _i37.PageRouteInfo<RutaListadoComunidadArgs> {
  ...
  static const _i37.PageInfo<RutaListadoComunidadArgs> page =
      _i37.PageInfo<RutaListadoComunidadArgs>(name);
}
...
/// generated route for
/// [_i23.PaginaLogin]
class RutaLogin extends _i37.PageRouteInfo<void> {
  const RutaLogin({List<_i37.PageRouteInfo>? children})
      : super(
          RutaLogin.name,
          initialChildren: children,
        );
...
class RutaMenuComunicaciones extends _i37.PageRouteInfo<void> {
  const RutaMenuComunicaciones({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaMenuComunidadAcademica extends _i37.PageRouteInfo<void> {
  const RutaMenuComunidadAcademica({List<_i37.PageRouteInfo>? children})
      : super(
...
class RutaMisCursos extends _i37.PageRouteInfo<void> {
  const RutaMisCursos({List<_i37.PageRouteInfo>? children})
      : super(
          RutaMisCursos.name,
          initialChildren: children,
        );
...
class RutaPerfilComunicados
    extends _i37.PageRouteInfo<RutaPerfilComunicadosArgs> {
  ...
  static const _i37.PageInfo<RutaPerfilComunicadosArgs> page =
      _i37.PageInfo<RutaPerfilComunicadosArgs>(name);
}
...
class RutaPerfilUsuario extends _i37.PageRouteInfo<RutaPerfilUsuarioArgs> {
  RutaPerfilUsuario({
    required int idUsuario,
    _i38.Key? key,
    List<_i37.PageRouteInfo>? children,
  ...
  static const _i37.PageInfo<RutaPerfilUsuarioArgs> page =
      _i37.PageInfo<RutaPerfilUsuarioArgs>(name);
}
...
class RutaPerfilUsuarioPendiente
    extends _i37.PageRouteInfo<RutaPerfilUsuarioPendienteArgs> {
  ...
  static const _i37.PageInfo<RutaPerfilUsuarioPendienteArgs> page =
      _i37.PageInfo<RutaPerfilUsuarioPendienteArgs>(name);
}
...
/// generated route for
/// [_i30.PaginaRegistro]
class RutaRegistro extends _i37.PageRouteInfo<void> {
  const RutaRegistro({List<_i37.PageRouteInfo>? children})
      : super(
          RutaRegistro.name,
          initialChildren: children,
        );
...
class RutaSeleccionDeRol extends _i37.PageRouteInfo<void> {
  const RutaSeleccionDeRol({List<_i37.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i32.PaginaSupervision]
class RutaSupervision extends _i37.PageRouteInfo<void> {
  const RutaSupervision({List<_i37.PageRouteInfo>? children})
      : super(
          RutaSupervision.name,
          initialChildren: children,
        );

  static const String name = 'RutaSupervision';

  static const _i37.PageInfo<void> page = _i37.PageInfo<void>(name);
}

/// generated route for
/// [_i33.PaginaSupervisionAsignatura]
class RutaSupervisionAsignatura
    extends _i37.PageRouteInfo<RutaSupervisionAsignaturaArgs> {
  RutaSupervisionAsignatura({
    ...
    List<_i37.PageRouteInfo>? children,
          ...
          RutaSupervisionAsignatura.name,
          args: RutaSupervisionAsignaturaArgs(
            idAsignatura: idAsignatura,
            idComision: idComision,
            fecha: fecha,
            key: key,
  ...
  static const String name = 'RutaSupervisionAsignatura';

  static const _i37.PageInfo<RutaSupervisionAsignaturaArgs> page =
      _i37.PageInfo<RutaSupervisionAsignaturaArgs>(name);
}

class RutaSupervisionAsignaturaArgs {
  const RutaSupervisionAsignaturaArgs({
    required this.idAsignatura,
    required this.idComision,
    required this.fecha,
    this.key,
  ...
  @override
  String toString() {
    return 'RutaSupervisionAsignaturaArgs{idAsignatura: $idAsignatura, idComision: $idComision, fecha: $fecha, key: $key}';
  }
}

/// generated route for
/// [_i34.PaginaSupervisionComisiones]
class RutaSupervisionComisiones extends _i37.PageRouteInfo<void> {
  const RutaSupervisionComisiones({List<_i37.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i35.PaginaSupervisionEnvioCalificaciones]
class RutaSupervisionEnvioCalificaciones
    extends _i37.PageRouteInfo<RutaSupervisionEnvioCalificacionesArgs> {
  ...
  static const _i37.PageInfo<RutaSupervisionEnvioCalificacionesArgs> page =
      _i37.PageInfo<RutaSupervisionEnvioCalificacionesArgs>(name);
}
...
/// generated route for
/// [_i36.PaginaUsuariosPendientes]
class RutaUsuariosPendientes extends _i37.PageRouteInfo<void> {
  const RutaUsuariosPendientes({List<_i37.PageRouteInfo>? children})
      : super(
